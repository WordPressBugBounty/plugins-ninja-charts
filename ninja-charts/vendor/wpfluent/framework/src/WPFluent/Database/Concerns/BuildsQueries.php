...
use NinjaCharts\Framework\Support\Conditionable;
...
use NinjaCharts\Framework\Database\MultipleRecordsFoundException;
use NinjaCharts\Framework\Pagination\Cursor;
use NinjaCharts\Framework\Pagination\Paginator;
use NinjaCharts\Framework\Pagination\CursorPaginator;
use NinjaCharts\Framework\Pagination\LengthAwarePaginator;

/**
 * @template TValue
 *
 * @mixin \NinjaCharts\Framework\Database\Orm\Builder
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\NinjaCharts\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \NinjaCharts\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Query\Builder|\NinjaCharts\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \NinjaCharts\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \NinjaCharts\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
