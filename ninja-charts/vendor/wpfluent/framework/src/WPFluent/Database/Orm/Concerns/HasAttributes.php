...
use NinjaCharts\Framework\Support\DateTime;
use NinjaCharts\Framework\Support\ArrayableInterface;
use NinjaCharts\Framework\Database\Orm\Casts\Attribute;
use NinjaCharts\Framework\Database\Orm\Castable;
use NinjaCharts\Framework\Database\Orm\Casts\AsCollection;
use NinjaCharts\Framework\Database\Orm\Casts\AsArrayObject;
use NinjaCharts\Framework\Database\Orm\Relations\Relation;
use NinjaCharts\Framework\Database\Orm\InvalidCastException;
use NinjaCharts\Framework\Database\Orm\JsonEncodingException;
use NinjaCharts\Framework\Database\LazyLoadingViolationException;
use NinjaCharts\Framework\Database\Orm\CastsInboundAttributes;
use NinjaCharts\Framework\Support\Collection as BaseCollection;
use NinjaCharts\Framework\Database\Orm\MissingAttributeException;
...
trait HasAttributes
{
     ...
     *
     * @var \NinjaCharts\Framework\Encryption\Encrypter
     */
     ...
     * @return null
     *
     * @throws \NinjaCharts\Framework\Database\Orm\MissingAttributeException
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Encryption\Encrypter  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \NinjaCharts\Framework\Database\Orm\InvalidCastException
     */
