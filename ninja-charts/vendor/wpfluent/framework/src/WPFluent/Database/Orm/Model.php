...
use NinjaCharts\Framework\Support\CanBeEscapedWhenCastToString;
...
use NinjaCharts\Framework\Database\Orm\Collection as OrmCollection;
...
abstract class Model implements ArrayableInterface, ArrayAccess, CanBeEscapedWhenCastToString, JsonableInterface, JsonSerializable, UrlRoutable
{
     ...
     *
     * @param  \NinjaCharts\Framework\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     * @return string
     *
     * @throws \NinjaCharts\Framework\Database\Orm\JsonEncodingException
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Orm\Model|null  $model
     * @return bool
     */
     ...
     * @return \NinjaCharts\Framework\Database\Orm\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \NinjaCharts\Framework\Database\Orm\Model  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \NinjaCharts\Framework\Database\Orm\Builder
     */
