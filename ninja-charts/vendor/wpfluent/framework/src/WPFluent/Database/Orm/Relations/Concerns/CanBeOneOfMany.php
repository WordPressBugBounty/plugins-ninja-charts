...
namespace NinjaCharts\Framework\Database\Orm\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \NinjaCharts\Framework\Database\Orm\Builder|null
     */
     ...
     * @param  \NinjaCharts\Framework\Database\Orm\Builder  $subQuery
     * @param  string  $on
     * @return void
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Orm\Builder|void
     */
