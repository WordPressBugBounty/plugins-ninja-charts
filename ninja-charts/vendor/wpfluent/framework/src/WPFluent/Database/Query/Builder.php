...
use NinjaCharts\Framework\Support\LazyCollection;
use NinjaCharts\Framework\Database\Query\Expression;
use NinjaCharts\Framework\Database\Query\Grammars\Grammar;
use NinjaCharts\Framework\Database\Query\Processors\Processor;
use NinjaCharts\Framework\Database\Query\ConditionExpression;
...
class Builder
{
     ...
     *
     * @var \NinjaCharts\Framework\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \NinjaCharts\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \NinjaCharts\Framework\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \NinjaCharts\Framework\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\NinjaCharts\Framework\Database\Query\Builder|string  $table
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \NinjaCharts\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\NinjaCharts\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \NinjaCharts\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \Closure|\NinjaCharts\Framework\Database\Orm\Builder|\NinjaCharts\Framework\Database\Query\Builder|\NinjaCharts\Framework\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\NinjaCharts\Framework\Database\Query\Builder|\NinjaCharts\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \NinjaCharts\Framework\Database\RecordsNotFoundException
     * @throws \NinjaCharts\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Support\Collection  $items
     * @return \NinjaCharts\Framework\Support\Collection
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Query\Grammars\Grammar
     */
