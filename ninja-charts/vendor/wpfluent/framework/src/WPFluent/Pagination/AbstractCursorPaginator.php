...
/**
 * @mixin \NinjaCharts\Framework\Support\Collection
 */
abstract class AbstractCursorPaginator
{
     ...
     * The current cursor.
     *
     * @var \NinjaCharts\Framework\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \NinjaCharts\Framework\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \NinjaCharts\Framework\Pagination\Cursor|null
     */
     ...
     * @param  bool  $isNext
     * @return \NinjaCharts\Framework\Pagination\Cursor
     */
