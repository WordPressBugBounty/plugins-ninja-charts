...
use NinjaCharts\Framework\Validator\Rules\In;
use NinjaCharts\Framework\Validator\Rules\NotIn;
use NinjaCharts\Framework\Validator\Rules\Unique;
use NinjaCharts\Framework\Validator\Rules\Exists;
use NinjaCharts\Framework\Validator\Rules\RequiredIf;
use NinjaCharts\Framework\Validator\Rules\Dimensions;
use NinjaCharts\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \NinjaCharts\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \NinjaCharts\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \NinjaCharts\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Support\ArrayableInterface|array|string  $values
     * @return \NinjaCharts\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Support\ArrayableInterface|array|string  $values
     * @return \NinjaCharts\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \NinjaCharts\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \NinjaCharts\Framework\Validator\Rules\Unique
     */
